...
export const HomeProducts5: React.FC = () => {
...
export const Products: React.FC = () => {
    ...
    useEffect(() => {
        setProducts([{
            idProduct: 7,
            restaurante: 'Gaón Artesanal - El Sindicato',
            ciudad: 'Cali, Valle del Cauca, Colombia',
            direccion: 'Carrera 34 # 3-61',
            telefono: '3044448325',
            tipo_restaurante: 'Comidas rapidas',
            nombre_plato: 'Combo Doble Cheese + Americanas',
            descripcion_plato: 'Hamburguesa de 300 g carne Angus, doble queso americano, lechuga, tomate, mostaza dulce, papas americanas y 1 bebida a elección. ideal 2 personas.',
            precio: 56650,
            img_plato: 'https://images.rappi.com/products/55067bea-e260-4f5a-83b8-a3133116692d-1687031350493.png?e=webp&d=511x511&q=85',
            tiempo_entreda_pedido: '24 min',
            precio_domicilio: 0,
            valor_compra: 0,
            latitud: 3.398,
            longitud: -76.545
            ...
            telefono: '3044448325',
            tipo_restaurante: 'Comidas rapidas',
            nombre_plato: '2 Combos Cheese & Bacon',
            descripcion_plato: 'Hamburguesa x2 con 150 gramos de carne angus, queso americano, tocineta, lechuga, tomate, mostaza dulce, 2 papas francesas y 2 bebidas.',
            precio: 64650,
            img_plato: 'https://images.rappi.com/products/f8efb2de-58ef-44a9-b98c-6022a6673c82-1687031144316.png?e=webp&d=511x511&q=85',
            ...
            telefono: '3044448325',
            tipo_restaurante: 'Comidas rapidas',
            nombre_plato: 'Combo 2 Burger Gaón',
            descripcion_plato: 'Hamburguesa x2 de 150g Angus c/u, queso philadelphia, cebolla caramelizada, tocineta, lechuga, tomate, 2 papas francesas y 2 bebidas.',
            precio: 70250,
            img_plato: 'https://images.rappi.com/products/2097750483-1709164625093.jpg?e=webp&d=511x511&q=85',
            tiempo_entreda_pedido: '30 min',
            precio_domicilio: 0,
            valor_compra: 0,
            latitud: 3.398,
            longitud: -76.545
