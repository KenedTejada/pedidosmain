...
export const Products: React.FC = () => {
    ...
    useEffect(() => {
        setProducts([{
            ...
            direccion: 'Calle 12 # 6N-16',
            telefono: '(602)6602800⁣',
            tipo_restaurante: 'Comidas rapidas',
            nombre_plato: 'Sándwich personal roast beef (21 cms) + Coca-cola sabor original 250ml.',
            descripcion_plato: 'Piña Calada, Carne de Costilla de Cerdo Desmechada, Carne de Res Desmechada, Jamón de Cerdo, Roast Beef.',
            precio: 22000,
            img_plato: 'https://images.rappi.com/products/tmp603813804453969962661709517.png?e=webp&d=511x511&q=85',
            tiempo_entreda_pedido: '45 min',
            precio_domicilio: 0,
            valor_compra: 0,
            latitud: 3.456,
            longitud: -76.533,
