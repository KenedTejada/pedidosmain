...
export const HomeProducts4: React.FC = () => {
...
export const Products: React.FC = () => {
    ...
    useEffect(() => {
        setProducts([{
            idProduct: 6,
            restaurante: 'Chicken Wings',
            ciudad: 'Cali, Valle del Cauca, Colombia',
            direccion: 'VALLE DEL LILI Clle 48 #86-125',
            telefono: '3103923038⁣',
            tipo_restaurante: 'Comidas rapidas',
            nombre_plato: 'Combo amigos 7 personas',
            descripcion_plato: '12 piezas de ala 500gr de Boneless con salsa BBQ, 1 porcion de costilla ahumada, 6 arepas, Papa francesa, Papa criolla, Queso cheddar y tocineta.',
            precio: 125000,
            img_plato: 'https://tofuu.getjusto.com/orioneat-local/resized2/epqNRuu4v7PsQcfAv-1200-1200.webp',
            tiempo_entreda_pedido: '20 min',
            precio_domicilio: 0,
            valor_compra: 0,
            latitud: 3.398,
            longitud: -76.545
