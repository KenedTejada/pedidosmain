...
export const HomeProducts2: React.FC = () => {
...
export const Products: React.FC = () => {
    ...
    useEffect(() => {
        setProducts([{
            idProduct: 2,
            restaurante: 'Burguer master',
            ciudad: 'Cali, Valle del Cauca, Colombia',
            direccion: 'AVENIDA 6 NORTE #14-60',
            telefono: '3122837377',
            tipo_restaurante: 'Pizza - Spizzica',
            nombre_plato: '4 Porciones de Pizza + Manzana 1.5LT - Combo 1',
            descripcion_plato: '4 Porciones de Pizza + coca cola 1.5LT',
            precio: 34400,
            img_plato: 'https://images.rappi.com/products/2089968006-1515525076.png?e=webp&d=511x511&q=85',
            tiempo_entreda_pedido: '15 min',
            precio_domicilio: 0,
            valor_compra: 0,
            latitud: -25.344,
            longitud: 131.031
            ...
            ciudad: 'Cali, Valle del Cauca, Colombia',
            direccion: '7u-12, Calle 70#',
            telefono: '3108422530',
            tipo_restaurante: 'Hamburguesas',
            nombre_plato: 'Stacker',
            descripcion_plato: '200 g de carne ANGUS, pan artesanal, queso philadelphia, cebolla caramelizada, lechuga crespa, papas fritas y salsa a base de whisky y BBQ.',
            precio: 26900,
            img_plato: 'https://cdn.businessinsider.es/sites/navi.axelspringer.es/public/media/image/2023/07/hamburguesa-3096800.jpg?tf=1200x',
            tiempo_entreda_pedido: '15 min',
            precio_domicilio: 0,
            valor_compra: 0,
            latitud: 0,
